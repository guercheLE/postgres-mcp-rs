...
impl McpifyServer {
    ...
    #[tool(
        description = "Semantic search for PostgreSQL catalog operations using a natural-language query."
    )]
    async fn search(
        &self,
    ...
    #[tool(
        description = "Return the schema, path, method, and documentation for a specific PostgreSQL catalog operationId."
    )]
    ...
    #[tool(
        description = "Validate arguments, invoke a live PostgreSQL catalog operation, and validate the response."
    )]
    async fn call(
        &self,
