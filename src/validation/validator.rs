...
fn schemas_zst_for(api_version: &str) -> Option<&'static [u8]> {
    match api_version {
        "18" => Some(include_bytes!("generated_schemas.json.zst")),
        "17" => Some(include_bytes!("generated_schemas_v17.json.zst")),
        "16" => Some(include_bytes!("generated_schemas_v16.json.zst")),
        "15" => Some(include_bytes!("generated_schemas_v15.json.zst")),
        "14" => Some(include_bytes!("generated_schemas_v14.json.zst")),
        "19beta2" => Some(include_bytes!("generated_schemas_v19beta2.json.zst")),
        _ => None,
    }
}
// mcpify:versions:end
...
mod tests {
    ...
    fn an_unknown_operation_id_falls_back_to_an_always_valid_schema() {
        ...
        assert!(validate_output("18", "__unknown_operation__", &serde_json::json!(42)).is_ok());
    }
